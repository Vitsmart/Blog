  ...
  return (
    <div className='singlePost'>
        <div className="singlePostWrapper">
            <img src='https://images.unsplash.com/photo-1627556704283-452301a45fd0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Z3JhZHVhdGlvbiUyMGNlcmVtb255fGVufDB8fDB8fA%3D%3D&w=1000&q=80'alt='' className='singlePostImg' />
